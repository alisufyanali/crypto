            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-900 font-mono font-medium">#{user.id.toString().padStart(6, '0')}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-600">KYC Documents</label>
                  <p className="text-gray-900 font-medium">{user.kyc_documents.length} documents uploaded</p>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            {user.kyc_documents.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">This user hasn't uploaded any KYC documents yet.</p>
              </div>
            )}
          </CardContent>
        </Card>
