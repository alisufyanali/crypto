...
import { ArrowLeft, TrendingUp, TrendingDown, Calculator, AlertCircle, Save } from 'lucide-react';
...
export default function EditOrder({ order, companies, userBalance }: Props) {
  const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Dashboard', href: '/dashboard' },
    { title: 'Orders', href: '/orders' },
    { title: `Edit Order #${order.id}`, href: '#' }
  ];
  ...
  const [formData, setFormData] = useState({
    ...
    price_per_share: order.price_per_share.toString(),
  });

  const [errors, setErrors] = useState<Record<string, string>>({});
  const [processing, setProcessing] = useState(false);
  const [selectedCompany, setSelectedCompany] = useState<Company | null>(order.company);
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Cannot Edit Order</h2>
              <p className="text-gray-600 mb-6">
                Only pending orders can be edited. This order has status: <strong>{order.status}</strong>
              </p>
              <Link
                href="/orders"
            ...
            <div className="flex items-center justify-between py-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Modify order details before submission</p>
                </div>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-600 mt-1">
                      Updated orders will require re-approval from our brokers before execution.
                    </p>
                  </div>
                </div>
              </div>
